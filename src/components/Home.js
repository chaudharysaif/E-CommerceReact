        ...
        <div>
                ...
                <div className="container text-white fw-bolder text-md-start text-center">
                    <div className="row">
                        <div className="col-md-6 offset-md-1">
                            ...
                            <div className="my-4">
                                <button className="btn btn-light p-3 px-4 fw-semibold" style={{ borderRadius: "0" }}>
                                    SHOP NOW
                                </button>
                                <button className="btn btn-outline-light mx-4 p-3 px-4 fw-semibold" style={{ borderRadius: "0" }}>
                                    FIND MORE
                                </button>
                            </div>
                        </div>
            ...
            <div className="my-5 p-5 text-light" style={{ backgroundColor: "#2e7db0", fontFamily: "georgia" }}>
                <div className="row p-4">
                    <div className="col-12 col-md-5 col-lg-4 text-center m-auto">
                        <img src="homedisplay4.jpg" alt="Zipper Image" height={"430px"} />
                    </div>
                    <div className="col-md-7" >
                        <div>
                            ...
                            <h5 className='my-3'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis officiis illum, similique id
            ...
            <div className="my-5 p-5" style={{ backgroundColor: "#f5f7f9" }}>
                <div>
                    ...
                    <div className="row mt-3 p-0 d-flex justify-content-center">
                        <div className="col-12 col-md-6 col-lg-5 m-4 p-5" style={{ backgroundColor: "#ffffff" }}>
                            <img src="https://via.placeholder.com/150" alt="Rounded Profile" className='rounded img-fluid' /> <span> <h5 className='m-0'>John Marith</h5></span>
                        ...
                        <div className="col-12 col-md-6 col-lg-5 m-4 p-5" style={{ backgroundColor: "#ffffff" }}>
                            <img src="https://via.placeholder.com/150" alt="Rounded Profile" className='rounded img-fluid' /> <span><h5 className='m-0'>Sam Cony</h5></span>
