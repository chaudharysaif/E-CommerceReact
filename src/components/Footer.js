            ...
            <footer>
                <ul className="container  nav justify-content-center border-bottom my-5 p-3">
                    ...
                    <div className="mx-auto text-center d-flex">
                        ...
                        <li className="nav-item"><Link to="/product" className="nav-link text-body-secondary">SHOP</Link></li>
                        <li className="nav-item"><Link to="/about" className="nav-link text-body-secondary">ABOUT</Link></li>
                        <li className="nav-item"><Link to="/contact" className="nav-link text-body-secondary">CONTACT</Link></li>
                    </div>
                    ...
                    <div className="d-flex justify-content-center p-2">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-instagram mx-2" viewBox="0 0 16 16">
